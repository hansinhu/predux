...
import { PreduxModel, createModel, createOldModel } from './createModel'
import { makeRegisterPredux } from './migration'
...
const createPreduxStoreFactory = (models: PreduxModel[], middlewares: Middleware[] = []) => {
  ...
  return function preduxStoreFactory(outerInitialState?: any, ctx?: any) {
...
export type PreduxStoreFactory = ReturnType<typeof createPreduxStoreFactory>

export * from 'react-redux'
export { withRedux, createModel, createPreduxStoreFactory, createOldModel }

/**
 * 旧版的 registerPredux, 推荐使用新版的 createPreduxStoreFactory
 *
 * @deprecated
 */
const registerPredux = makeRegisterPredux(createStoreEnhancer)
export default registerPredux
